...
class App{
   ...
   moveDolly(dt){
    ...
    // Handle forward/backward/left/right movement
    ...
    if (this.selectPressed && !moved) {
        // Controller movement fallback
    ...
    if (moved) {
        ...
        // cast left
        let dir = new THREE.Vector3(-1, 0, 0).applyMatrix4(this.dolly.matrix).normalize();
        this.raycaster.set(pos, dir);
